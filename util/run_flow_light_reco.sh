...
#output_folder=/global/cfs/cdirs/dune/users/sfogarty/Module0_reco
...
#data_folder=/global/u1/s/sfogarty> ls /global/cfs/cdirs/dune/www/data/Module0/LRS
#ADC_name_1=0a7a314c
#file_timestamp=20210402_013857
...
#output_file=${output_folder}/light_events_${ADC_name_1}_${ADC_name_2}_${file_timestamp}_test.h5
output_file=${output_folder}/light_events_${ADC_name_1}_${file_timestamp}.h5
